...
name: ci
description:
  A specialized skill for Sparkle CLI that provides high-performance, fail-fast
...
- **Tool**: `node .sparkle/skills/ci/scripts/ci.mjs [branch]`
...
- **Tool**: `node .sparkle/skills/ci/scripts/ci.mjs [branch] [run_id]`
- **Discovery**: The script **automatically** finds the latest active or recent
