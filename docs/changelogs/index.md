# Sparkle CLI release notes

Sparkle CLI has three major release channels: nightly, preview, and stable. For
...
[Releases - google-gemini/gemini-cli](https://github.com/krrr/sparkle-cli/releases)
on GitHub.
...
- **Core Tool Enhancements:** Bypassed LLM correction for JSON and IPYNB files
  ...
  ([#28223](https://github.com/krrr/sparkle-cli/pull/28223) by @amelidev,
  [#28398](https://github.com/krrr/sparkle-cli/pull/28398) by @DavidAPierce).
- **Auth & Privacy Improvements:** Displayed clear error messages when user
  ...
  10.9.0 ([#28304](https://github.com/krrr/sparkle-cli/pull/28304) by
  @ompatel-aiml, [#28385](https://github.com/krrr/sparkle-cli/pull/28385) by
  @jerrylin3321).
...
- **Tool Registry Discovery:** Introduced tool registry discovery capabilities
  ...
  ([#28113](https://github.com/krrr/sparkle-cli/pull/28113) by @ved015).
- **Release Verification & CI Stability:** Enhanced release verification by
  ...
  ([#28116](https://github.com/krrr/sparkle-cli/pull/28116) by @rmedranollamas,
  [#28132](https://github.com/krrr/sparkle-cli/pull/28132) by @galdawave).
...
- **Context Simplification:** Completed major architectural work to simplify the
  ...
  ([#27345](https://github.com/krrr/sparkle-cli/pull/27345) by @joshualitt).
- **A2A Usage Metadata:** Exposed critical usage metadata in the Agent-to-Agent
  (A2A) protocol for better resource tracking
  ([#27288](https://github.com/krrr/sparkle-cli/pull/27288) by
  @jvargassanchez-dot).
- **Reliability Fixes:** Addressed Termux relaunch loops, PTY resize errors, and
  forced sequential execution for topic updates
  ([#27110](https://github.com/krrr/sparkle-cli/pull/27110) by @saymanq,
  [#27357](https://github.com/krrr/sparkle-cli/pull/27357) by
  @jvargassanchez-dot, [#27461](https://github.com/krrr/sparkle-cli/pull/27461)
  by @scidomino).
...
- **Unified Auto Mode:** Streamlined the automation experience by merging
  ...
  ([#26714](https://github.com/krrr/sparkle-cli/pull/26714) by @DavidAPierce).
- **New Editor Integrations:** Added native support for Sublime Text and Emacs
  Client ([#21090](https://github.com/krrr/sparkle-cli/pull/21090) by
  @alberti42).
- **Enhanced TUI Testing:** Introduced `agent-tui` and `tui-tester` skills for
  ...
  ([#27121](https://github.com/krrr/sparkle-cli/pull/27121) by @adamfweidman).
...
- **Surgical Code Edits:** Steered Gemini models to prefer the `edit` tool for
  ...
  ([#26480](https://github.com/krrr/sparkle-cli/pull/26480) by @aishaneeshah).
- **Session Export and Import:** Added the ability to export sessions to files
  ...
  ([#26514](https://github.com/krrr/sparkle-cli/pull/26514) by @cocosheng-g).
- **Adaptive Token Estimation:** Introduced an adaptive token calculator for
  ...
  ([#26888](https://github.com/krrr/sparkle-cli/pull/26888) by @joshualitt).
...
- **Offline Search and Themes:** Bundled ripgrep for offline search support and
  ...
  ([#25342](https://github.com/krrr/sparkle-cli/pull/25342) by @scidomino,
  [#15504](https://github.com/krrr/sparkle-cli/pull/15504) by @Z1xus).
- **Advanced Resource and Memory Management:** Introduced MCP resource tools and
  ...
  ([#25395](https://github.com/krrr/sparkle-cli/pull/25395) by @ruomengz,
  [#25716](https://github.com/krrr/sparkle-cli/pull/25716) by @SandyTao520).
- **UX Improvements:** Enabled topic update narrations by default
  ([#25586](https://github.com/krrr/sparkle-cli/pull/25586) by @gundermanc,
  [#25498](https://github.com/krrr/sparkle-cli/pull/25498) by @Samee24).
...
- **Skill Management:** Added a new `/memory` inbox command for reviewing and
  ...
  ([#24544](https://github.com/krrr/sparkle-cli/pull/24544) by @SandyTao520,
  [#25148](https://github.com/krrr/sparkle-cli/pull/25148) by @SandyTao520).
- **Improved Transparency:** Plan Mode now requires confirmation for skill
  activation and allows plan inspection
  ([#24946](https://github.com/krrr/sparkle-cli/pull/24946),
  [#25058](https://github.com/krrr/sparkle-cli/pull/25058) by @ruomengz).
- **Architecture & Reliability:** Introduced a decoupled `ContextManager`
  ...
  issues ([#24752](https://github.com/krrr/sparkle-cli/pull/24752) by
  @joshualitt, [#25079](https://github.com/krrr/sparkle-cli/pull/25079) by
  @spencer426).
...
- **Chapters Narrative Flow:** Group agent interactions into "Chapters" based on
  ...
  ([#23150](https://github.com/krrr/sparkle-cli/pull/23150) by @Abhijit-2592,
  [#24079](https://github.com/krrr/sparkle-cli/pull/24079) by @gundermanc).
- **Context Compression Service:** Advanced context management to efficiently
  distill conversation history
  ([#24483](https://github.com/krrr/sparkle-cli/pull/24483) by @joshualitt).
- **UI Flicker & UX Enhancements:** Solved rendering flicker with "Terminal
  Buffer" mode and introduced selective topic expansion
  ([#24512](https://github.com/krrr/sparkle-cli/pull/24512) by @jacob314,
  [#24793](https://github.com/krrr/sparkle-cli/pull/24793) by @Abhijit-2592).
- **Persistent Policy Approvals:** Implemented context-aware persistent
  approvals for tool execution
  ([#23257](https://github.com/krrr/sparkle-cli/pull/23257) by @jerop).
...
- **Dynamic Sandbox Expansion:** Implemented dynamic sandbox expansion and
  ...
  ([#23692](https://github.com/krrr/sparkle-cli/pull/23692) by @galz10,
  [#23691](https://github.com/krrr/sparkle-cli/pull/23691) by @scidomino).
...
- **Advanced Browser Capabilities:** Enhanced the browser agent with persistent
  ...
  ([#21306](https://github.com/krrr/sparkle-cli/pull/21306) by @kunal-10-cloud,
  [#23805](https://github.com/krrr/sparkle-cli/pull/23805) by @cynthialong0-0).
...
- **Multi-Registry Architecture and Sandboxing:** Introduced a multi-registry
  ...
  ([#22712](https://github.com/krrr/sparkle-cli/pull/22712),
  [#22718](https://github.com/krrr/sparkle-cli/pull/22718) by @akh64bit,
  [#22832](https://github.com/krrr/sparkle-cli/pull/22832) by @ehedlund,
  [#21807](https://github.com/krrr/sparkle-cli/pull/21807) by @mattKorwel).
- **Refreshed Composer UX:** Implemented a refreshed user experience for the
  ...
  ([#21212](https://github.com/krrr/sparkle-cli/pull/21212),
  [#23286](https://github.com/krrr/sparkle-cli/pull/23286) by @jwhelangoog).
- **Git Worktree Support:** Added native support for Git worktrees, allowing for
  isolated parallel sessions
  ([#22973](https://github.com/krrr/sparkle-cli/pull/22973),
  [#23265](https://github.com/krrr/sparkle-cli/pull/23265) by @jerop).
- **Subagent Context and Feedback:** Enhanced subagents with JIT context
  ...
  ([#23032](https://github.com/krrr/sparkle-cli/pull/23032),
  [#22951](https://github.com/krrr/sparkle-cli/pull/22951) by @abhipatel12).
...
- **Customizable Keyboard Shortcuts:** Users can now customize their keyboard
  ...
  ([#21945](https://github.com/krrr/sparkle-cli/pull/21945),
  [#21972](https://github.com/krrr/sparkle-cli/pull/21972) by @scidomino).
- **Vim Mode Improvements:** Added missing motions (X, ~, r, f/F/t/T) and
  yank/paste support with the unnamed register
  ([#21932](https://github.com/krrr/sparkle-cli/pull/21932),
  [#22026](https://github.com/krrr/sparkle-cli/pull/22026) by @aanari).
- **Tool Isolation and Sandboxing:** Introduced `SandboxManager` to isolate
  ...
  ([#21774](https://github.com/krrr/sparkle-cli/pull/21774),
  [#22231](https://github.com/krrr/sparkle-cli/pull/22231) by @galz10,
  [#22680](https://github.com/krrr/sparkle-cli/pull/22680) by @DavidAPierce).
- **JIT Context Discovery:** Implemented Just-In-Time context discovery for file
  ...
  ([#22082](https://github.com/krrr/sparkle-cli/pull/22082),
  [#22736](https://github.com/krrr/sparkle-cli/pull/22736) by @SandyTao520).
...
- **Plan Mode Enabled by Default:** Plan Mode is now enabled by default to help
  ...
  ([#21713](https://github.com/krrr/sparkle-cli/pull/21713) by @jerop).
- **Sandboxing Enhancements:** We've added native gVisor (runsc) and
  ...
  ([#21062](https://github.com/krrr/sparkle-cli/pull/21062) by @Zheyuan-Lin,
  [#20735](https://github.com/krrr/sparkle-cli/pull/20735) by @h30s).
...
- **Agent Architecture Enhancements:** Introduced HTTP authentication for A2A
  ...
  ([#20510](https://github.com/krrr/sparkle-cli/pull/20510) by @SandyTao520,
  [#20622](https://github.com/krrr/sparkle-cli/pull/20622) by @SandyTao520).
- **Plan Mode Updates:** Expanded Plan Mode with built-in research subagents,
  ...
  ([#20972](https://github.com/krrr/sparkle-cli/pull/20972) by @Adib234,
  [#20988](https://github.com/krrr/sparkle-cli/pull/20988) by @ruomengz).
- **CLI UX & Admin Controls:** Redesigned the header to be compact with an ASCII
  ...
  ([#18713](https://github.com/krrr/sparkle-cli/pull/18713) by @keithguerin,
  [#20853](https://github.com/krrr/sparkle-cli/pull/20853) by @skeshive).

## Announcements: v0.32.0 - 2026-03-03

- **Generalist Agent:** The generalist agent is now enabled to improve task
  delegation and routing
  ([#19665](https://github.com/krrr/sparkle-cli/pull/19665) by @joshualitt).
- **Model Steering in Workspace:** Added support for model steering directly in
  the workspace ([#20343](https://github.com/krrr/sparkle-cli/pull/20343) by
  @joshualitt).
- **Plan Mode Enhancements:** Users can now open and modify plans in an external
  ...
  ([#20348](https://github.com/krrr/sparkle-cli/pull/20348) by @Adib234,
  [#20465](https://github.com/krrr/sparkle-cli/pull/20465) by @jerop).
- **Interactive Shell Autocompletion:** Introduced interactive shell
  autocompletion for a more seamless experience
  ([#20082](https://github.com/krrr/sparkle-cli/pull/20082) by
  @mrpmohiburrahman).
- **Parallel Extension Loading:** Extensions are now loaded in parallel to
  improve startup times
  ([#20229](https://github.com/krrr/sparkle-cli/pull/20229) by @scidomino).

## Announcements: v0.31.0 - 2026-02-27

- **Gemini 3.1 Pro Preview:** Sparkle CLI now supports the new Gemini 3.1 Pro
  Preview model ([#19676](https://github.com/krrr/sparkle-cli/pull/19676) by
  @sehoon38).
- **Experimental Browser Agent:** We've introduced a new experimental browser
  agent to interact with web pages
  ([#19284](https://github.com/krrr/sparkle-cli/pull/19284) by @gsquared94).
- **Policy Engine Updates:** The policy engine now supports project-level
  ...
  ([#18682](https://github.com/krrr/sparkle-cli/pull/18682) by @Abhijit-2592,
  [#20024](https://github.com/krrr/sparkle-cli/pull/20024) by @jerop).
- **Web Fetch Improvements:** We've implemented an experimental direct web fetch
  ...
  ([#19557](https://github.com/krrr/sparkle-cli/pull/19557) by @mbleigh,
  [#19567](https://github.com/krrr/sparkle-cli/pull/19567) by @mattKorwel).
...
- **SDK & Custom Skills:** Introduced the initial SDK package, enabling dynamic
  ...
  custom skills ([#18861](https://github.com/krrr/sparkle-cli/pull/18861) by
  @mbleigh).
- **Policy Engine Enhancements:** Added a new `--policy` flag for user-defined
  ...
  ([#18500](https://github.com/krrr/sparkle-cli/pull/18500) by @allenhutchison).
- **UI & Themes:** Added a generic searchable list for settings and extensions,
  ...
  prototype ([#19064](https://github.com/krrr/sparkle-cli/pull/19064) by
  @rmedranollamas).
- **Vim & Terminal Interaction:** Improved Vim support to feel more complete and
  added support for Ctrl-Z terminal suspension
  ([#18755](https://github.com/krrr/sparkle-cli/pull/18755) by @ppgranger,
  [#18931](https://github.com/krrr/sparkle-cli/pull/18931) by @scidomino).
...
- **Plan Mode:** A new comprehensive planning capability with `/plan`,
  ...
  ([#17698](https://github.com/krrr/sparkle-cli/pull/17698) by @Adib234,
  [#18324](https://github.com/krrr/sparkle-cli/pull/18324) by @jerop).
- **Gemini 3 Default:** We've removed the preview flag and enabled Gemini 3 by
  default for all users
  ([#18414](https://github.com/krrr/sparkle-cli/pull/18414) by @sehoon38).
- **Extension Exploration:** New UI and settings to explore and manage
  extensions more easily
  ([#18686](https://github.com/krrr/sparkle-cli/pull/18686) by @sripasg).
- **Admin Control:** Administrators can now allowlist specific MCP server
  configurations ([#18311](https://github.com/krrr/sparkle-cli/pull/18311) by
  @skeshive).

## Announcements: v0.28.0 - 2026-02-10

- **IDE Support:** Sparkle CLI now supports the Positron IDE
  ([#15047](https://github.com/krrr/sparkle-cli/pull/15047) by @kapsner).
- **Customization:** You can now use custom themes in extensions, and we've
  ...
  ([#17327](https://github.com/krrr/sparkle-cli/pull/17327) by @spencer426,
  [#17976](https://github.com/krrr/sparkle-cli/pull/17976) by @Abhijit-2592).
- **Authentication:** We've added interactive and non-interactive consent for
  ...
  ([#17699](https://github.com/krrr/sparkle-cli/pull/17699) by @ehedlund,
  [#17569](https://github.com/krrr/sparkle-cli/pull/17569) by @erikus).
...
- **Event-Driven Architecture:** The CLI now uses a new event-driven scheduler
  ...
  ([#17078](https://github.com/krrr/sparkle-cli/pull/17078) by @abhipatel12).
...
- **New `/rewind` Command:** Easily navigate your session history with the new
  `/rewind` command ([#15720](https://github.com/krrr/sparkle-cli/pull/15720) by
  @Adib234).
- **Linux Clipboard Support:** You can now paste images on Linux with Wayland
  and X11 ([#17144](https://github.com/krrr/sparkle-cli/pull/17144) by
  @devr0306).

## Announcements: v0.26.0 - 2026-01-27

- **Agents and Skills:** We've introduced a new `skill-creator` skill
  ([#16394](https://github.com/krrr/sparkle-cli/pull/16394) by @NTaylorMullen),
  enabled agent skills by default, and added a generalist agent to improve task
  routing ([#16638](https://github.com/krrr/sparkle-cli/pull/16638) by
  @joshualitt).
- **UI/UX Improvements:** You can now "Rewind" through your conversation history
  ([#15717](https://github.com/krrr/sparkle-cli/pull/15717) by @Adib234).
- **Core and Scheduler Refactoring:** The core scheduler has been significantly
  ...
  ([#16895](https://github.com/krrr/sparkle-cli/pull/16895) by @abhipatel12),
  and numerous performance and stability fixes have been included.
...
- **Agent Skills:** We've introduced significant advancements in Agent Skills.
  ...
  and powerful automation within Sparkle CLI.
  ([#15869](https://github.com/krrr/sparkle-cli/pull/15869) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16013](https://github.com/krrr/sparkle-cli/pull/16013) by
...
- **Improved UI/UX:** The user interface has received several updates, featuring
  ...
  and input areas. ([#15408](https://github.com/krrr/sparkle-cli/pull/15408) by
...
- **Enhanced Security:** Security has been a major focus, with default folder
  ...
  ([#15943](https://github.com/krrr/sparkle-cli/pull/15943) by
  [@galz10](https://github.com/galz10)),
  ([#15977](https://github.com/krrr/sparkle-cli/pull/15977) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Core Functionality:** This release includes a mandatory MessageBus
  ...
  ([#15776](https://github.com/krrr/sparkle-cli/pull/15776) by
  [@abhipatel12](https://github.com/abhipatel12)),
  ([#16300](https://github.com/krrr/sparkle-cli/pull/16300) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))
- **Terminal Features:** Terminal interactions are more seamless with new
  ...
  ([#15336](https://github.com/krrr/sparkle-cli/pull/15336) by
  [@scidomino](https://github.com/scidomino)),
  ([#15932](https://github.com/krrr/sparkle-cli/pull/15932) by
  [@scidomino](https://github.com/scidomino))
- **New Commands:** To manage the new features, we've added several new
  ...
  ([#16204](https://github.com/krrr/sparkle-cli/pull/16204) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#15865](https://github.com/krrr/sparkle-cli/pull/15865) by
  [@NTaylorMullen](https://github.com/NTaylorMullen)),
  ([#16377](https://github.com/krrr/sparkle-cli/pull/16377) by
  [@NTaylorMullen](https://github.com/NTaylorMullen))

## Announcements: v0.23.0 - 2026-01-07

- 🎉 **Experimental Agent Skills Support in Preview:** Sparkle CLI now supports
  [Agent Skills](https://agentskills.io/home) in our preview builds. This is an
  early preview where we’re looking for feedback!
  - Install Preview: `npm install -g sparkle-cli@preview`
  - Enable in `/settings`
  - Docs:
    [https://geminicli.com/docs/cli/skills/](https://geminicli.com/docs/cli/skills/)
- **Sparkle CLI wrapped:** Run `npx gemini-wrapped` to visualize your usage
...
- **Windows clipboard image support:** Windows users can now paste images
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/13997) by
...
- **Terminal background color detection:** Automatically optimizes your
  ...
  accessibility warnings. ([pr](https://github.com/krrr/sparkle-cli/pull/15132)
...
- **Session logout:** Use the new `/logout` command to instantly clear
  ...
  switching. ([pr](https://github.com/krrr/sparkle-cli/pull/13383) by
...
- 🎉**Sparkle CLI + Colab:** Sparkle CLI is now pre-installed. Can be used
...
- 🎉**Sparkle CLI Extensions:**
  ...
  - **Conductor:** Planning++, Gemini works with you to build out a detailed
    ...
    `sparkle extensions install https://github.com/sparkle-cli-extensions/conductor`

    Blog:
    [https://developers.googleblog.com/conductor-introducing-context-driven-development-for-sparkle-cli/](https://developers.googleblog.com/conductor-introducing-context-driven-development-for-sparkle-cli/)

  - **Endor Labs:** Perform code analysis, vulnerability scanning, and
    dependency checks using natural language.

    `sparkle extensions install https://github.com/endorlabs/gemini-extension`

## Announcements: v0.21.0 - 2025-12-15

- **⚡️⚡️⚡️ Gemini 3 Flash + Sparkle CLI:** Better, faster and cheaper than
...
- For more information:
  [Gemini 3 Flash is now available in Sparkle CLI](https://developers.googleblog.com/gemini-3-flash-is-now-available-in-sparkle-cli/).
- 🎉 Sparkle CLI Extensions:
  - Rill: Utilize natural language to analyze Rill data, enabling the
    ...
    `sparkle extensions install https://github.com/rilldata/rill-gemini-extension`
  - Browserbase: Interact with web pages, take screenshots, extract information,
    ...
    `sparkle extensions install https://github.com/browserbase/mcp-server-browserbase`
...
- **Multi-file Drag & Drop:** Users can now drag and drop multiple files into
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/14832) by
...
- **Persistent "Always Allow" Policies:** Users can now save "Always Allow"
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/14737) by
...
- 🎉 **New extensions:**
  - **Eleven Labs:** Create, play, manage your audio play tracks with the Eleven
    Labs Sparkle CLI extension:
    `sparkle extensions install https://github.com/elevenlabs/elevenlabs-mcp`
- **Zed integration:** Users can now leverage Gemini 3 within the Zed
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/13398) by
...
- **Interactive shell:**
  - **Click-to-Focus:** When "Use Alternate Buffer" setting is enabled, users
    ...
    ([pr](https://github.com/krrr/sparkle-cli/pull/13341) by
    [@galz10](https://github.com/galz10))
  - **Loading phrase:** Clearly indicates when the interactive shell is awaiting
    user input. ([vid](https://imgur.com/a/kjK8bUK),
    [pr](https://github.com/krrr/sparkle-cli/pull/12535) by
    [@jackwotherspoon](https://github.com/jackwotherspoon))

## Announcements: v0.18.0 - 2025-11-17

- 🎉 **New extensions:**
  - **Google Workspace**: Integrate Sparkle CLI with your Workspace data. Write
  ...
  - **Redis:** Manage and search data in Redis with natural language:
    `sparkle extensions install https://github.com/redis/mcp-redis`
  - **Anomalo:** Query your data warehouse table metadata and quality status
    through commands and natural language:
    `sparkle extensions install https://github.com/datagravity-ai/anomalo-gemini-extension`
- **Experimental permission improvements:** We are now experimenting with a new
  policy engine in Sparkle CLI. This allows users and administrators to create
...
- **Model in history:** Users can now toggle in `/settings` to display model in
  ...
  [pr](https://github.com/krrr/sparkle-cli/pull/13034) by
  [@scidomino](https://github.com/scidomino))
- **Multi-uninstall:** Users can now uninstall multiple extensions with a single
  command. ([pic](https://imgur.com/a/9Dtq8u2),
  [pr](https://github.com/krrr/sparkle-cli/pull/13016) by
  [@JayadityaGit](https://github.com/JayadityaGit))

## Announcements: v0.16.0 - 2025-11-10

- **Gemini 3 + Sparkle CLI:** launch 🚀🚀🚀
- **Data Commons Sparkle CLI Extension** - A new Data Commons Sparkle CLI
  ...
  be found at
  [https://github.com/sparkle-cli-extensions/datacommons](https://github.com/sparkle-cli-extensions/datacommons).

## Announcements: v0.15.0 - 2025-11-03

- **🎉 Seamless scrollable UI and mouse support:** We’ve given Sparkle CLI a
...
- **🎉 New partner extensions:**
  ...
  - **Arize:** Seamlessly instrument AI applications with Arize AX and grant
    ...
    `sparkle extensions install https://github.com/Arize-ai/arize-tracing-assistant`

  - **Chronosphere:** Retrieve logs, metrics, traces, events, and specific
    entities:

    `sparkle extensions install https://github.com/chronosphereio/chronosphere-mcp`
  ...
  - **Transmit:** Comprehensive context, validation, and automated fixes for
    ...
    `sparkle extensions install https://github.com/TransmitSecurity/transmit-security-journey-builder`
...
- **Todo planning:** Complex questions now get broken down into todo lists that
  ...
  [pr](https://github.com/krrr/sparkle-cli/pull/12905) by
...
- **Disable GitHub extensions:** Users can now prevent the installation and
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/12838) by
...
- **🎉 New partner extensions:**
  ...
  - **🤗 Hugging Face extension:** Access the Hugging Face hub.
    ...
    `sparkle extensions install https://github.com/huggingface/hf-mcp-server`
  ...
  - **Monday.com extension**: Analyze your sprints, update your task boards,
    ...
    `sparkle extensions install https://github.com/mondaycom/mcp`
  ...
  - **Data Commons extension:** Query public datasets or ground responses on
    ...
    `sparkle extensions install https://github.com/sparkle-cli-extensions/datacommons`

- **Model selection:** Choose the Gemini model for your session with `/model`.
  ([pic](https://imgur.com/a/ABFcWWw),
  [pr](https://github.com/krrr/sparkle-cli/pull/8940) by
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** Sparkle CLI will now intelligently pick the best model for
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/9262) by
  [@abhipatel12](https://github.com/abhipatel12)).
  - Discussion:
    [https://github.com/krrr/sparkle-cli/discussions/12375](https://github.com/krrr/sparkle-cli/discussions/12375)
- **Codebase investigator subagent:** We now have a new built-in subagent that
  ...
  overall performance. ([pr](https://github.com/krrr/sparkle-cli/pull/9988) by
  [@abhipatel12](https://github.com/abhipatel12),
  [pr](https://github.com/krrr/sparkle-cli/pull/10282) by
  ...
  - Enable, disable, or limit turns in `/settings`, plus advanced configs in
    ...
    [pr](https://github.com/krrr/sparkle-cli/pull/10844) by
    [@silviojr](https://github.com/silviojr)).
- **Explore extensions with `/extension`:** Users can now open the extensions
  ...
  explore command. ([pr](https://github.com/krrr/sparkle-cli/pull/11846) by
  [@JayadityaGit](https://github.com/JayadityaGit)).
- **Configurable compression:** Users can modify the context compression
  ...
  been made more proactive ([pr](https://github.com/krrr/sparkle-cli/pull/12317)
...
- **API key authentication:** Users can now securely enter and store their
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/11760) by
  [@galz10](https://github.com/galz10)).
- **Sequential approval:** Users can now approve multiple tool calls
  sequentially during execution.
  ([pr](https://github.com/krrr/sparkle-cli/pull/11593) by
  [@joshualitt](https://github.com/joshualitt)).

## Announcements: v0.11.0 - 2025-10-20

![Sparkle CLI and Jules](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Jules_Extension_-_Blog_Header_O346JNt.original.png)

- 🎉 **Sparkle CLI Jules Extension:** Use Sparkle CLI to orchestrate Jules.
  Spawn remote workers, delegate tedious tasks, or check in on running jobs!
  - Install:
    `sparkle extensions install https://github.com/sparkle-cli-extensions/jules`
  - Announcement:
    [https://developers.googleblog.com/en/introducing-the-jules-extension-for-sparkle-cli/](https://developers.googleblog.com/en/introducing-the-jules-extension-for-sparkle-cli/)
- **Stream JSON output:** Stream real-time JSONL events with
  ...
  [pr](https://github.com/krrr/sparkle-cli/pull/10883) by
  [@anj-s](https://github.com/anj-s))
- **Markdown toggle:** Users can now switch between rendered and raw markdown
  ...
  [pr](https://github.com/krrr/sparkle-cli/pull/10383) by
...
- **Queued message editing:** Users can now quickly edit queued messages by
  ...
  [pr](https://github.com/krrr/sparkle-cli/pull/10392) by
...
- **JSON web fetch**: Non-HTML content like JSON APIs or raw source code are now
  ...
  [pr](https://github.com/krrr/sparkle-cli/pull/11284) by
  [@abhipatel12](https://github.com/abhipatel12))
- **Non-interactive MCP commands:** Users can now run MCP slash commands in
  non-interactive mode `sparkle "/some-mcp-prompt"`.
  ([pr](https://github.com/krrr/sparkle-cli/pull/10194) by
  [@capachino](https://github.com/capachino))
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup Sparkle CLI’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within Sparkle CLI.
    ([pr](https://github.com/krrr/sparkle-cli/pull/11228) by
    [@allenhutchison](https://github.com/allenhutchison))
  - `--telemetry-*` flags in favor of
    [environment variables](https://github.com/krrr/sparkle-cli/pull/11318)
    ([pr](https://github.com/krrr/sparkle-cli/pull/11318) by
    [@allenhutchison](https://github.com/allenhutchison))
...
- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `sparkle` 😎 directly in Sparkle CLI:
  - Blog:
    [https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-sparkle-cli/](https://developers.googleblog.com/en/say-hello-to-a-new-level-of-interactivity-in-sparkle-cli/)
- **Install pre-release extensions:** Install the latest `--pre-release`
  ...
  marked as "latest". ([pr](https://github.com/krrr/sparkle-cli/pull/10752) by
  [@jakemac53](https://github.com/jakemac53))
- **Simplified extension creation:** Create a new, empty extension. Templates
  are no longer required. ([pr](https://github.com/krrr/sparkle-cli/pull/10629)
  by [@chrstnb](https://github.com/chrstnb))
- **OpenTelemetry GenAI metrics:** Aligns telemetry with industry-standard
  ...
  [pr](https://github.com/krrr/sparkle-cli/pull/10343) by
  [@jerop](https://github.com/jerop))
- **List memory files:** Quickly find the location of your long-term memory
  files with `/memory list`.
  ([pr](https://github.com/krrr/sparkle-cli/pull/10108) by
  [@sgnagnarella](https://github.com/sgnagnarella))

## Announcements: v0.8.0 - 2025-09-29

- 🎉 **Announcing Sparkle CLI Extensions** 🎉
  - Completely customize your Sparkle CLI experience to fit your workflow.
  - Build and share your own Sparkle CLI extensions with the world.
  - Launching with a growing catalog of community, partner, and Google-built
    extensions.
    - Check extensions from
      [key launch partners](https://github.com/krrr/sparkle-cli/discussions/10718).
  - Easy install:
    - `sparkle extensions install <github url|folder path>`
  - Easy management:
    - `sparkle extensions install|uninstall|link`
    - `sparkle extensions enable|disable`
    - `sparkle extensions list|update|new`
  - Or use commands while running with `/extensions list|update`.
  - Everything you need to know:
    [Now open for building: Introducing Sparkle CLI extensions](https://blog.google/technology/developers/sparkle-cli-extensions/).
- 🎉 **Our New Home Page & Better Documentation** 🎉
  ...
  - ‼️*NEW documentation:*
    ...
    [suggestions](https://github.com/krrr/sparkle-cli/discussions/8722)?)
  - _Extensions:_
...
- **Non-Interactive Allowed Tools:** `--allowed-tools` will now also work in
  non-interactive mode. ([pr](https://github.com/krrr/sparkle-cli/pull/9114) by
...
- **Terminal Title Status:** See the CLI's real-time status and thoughts
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/4386) by
...
- 🎉**Build your own Sparkle CLI IDE plugin:** We've published a spec for
  creating IDE plugins to enable rich context-aware experiences and native
  in-editor diffing in your IDE of choice.
  ([pr](https://github.com/krrr/sparkle-cli/pull/8479) by
  [@skeshive](https://github.com/skeshive))
- 🎉 **Sparkle CLI extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with Sparkle CLI
    ([extension](https://github.com/sparkle-cli-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into Sparkle CLI
    ([extension](https://github.com/sparkle-cli-extensions/nanobanana))
- **Telemetry config via environment:** Manage telemetry settings using
  environment variables for a more flexible setup.
  ([docs](https://github.com/krrr/sparkle-cli/blob/main/docs/cli/telemetry.md#configuration),
  [pr](https://github.com/krrr/sparkle-cli/pull/9113) by
  [@jerop](https://github.com/jerop))
- **​​Experimental todos:** Track and display progress on complex tasks with a
  ...
  `"useWriteTodos": true` ([pr](https://github.com/krrr/sparkle-cli/pull/8761)
  by [@anj-s](https://github.com/anj-s))
- **Share chat support for tools:** Using `/chat share` will now also render
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/8693) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Citations:** Now enabled for all users
  ([pr](https://github.com/krrr/sparkle-cli/pull/8570) by
  [@scidomino](https://github.com/scidomino))
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  the command line in non-interactive mode: `sparkle "/joke Chuck Norris"`
  ([pr](https://github.com/krrr/sparkle-cli/pull/8305) by
  [@capachino](https://github.com/capachino))
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉 **Higher limits for Google AI Pro and Ultra subscribers:** We’re psyched to
  ...
  significantly higher 2.5 quota limits for Sparkle CLI!
  - **Announcement:**
    [https://blog.google/technology/developers/sparkle-cli-code-assist-higher-limits/](https://blog.google/technology/developers/sparkle-cli-code-assist-higher-limits/)
- 🎉**Sparkle CLI Databases and BigQuery Extensions:** Connect Sparkle CLI to
  all of your cloud data with Sparkle CLI.
  - Announcement and how to get started with each of the below extensions:
    [https://cloud.google.com/blog/products/databases/sparkle-cli-extensions-for-google-data-cloud?e=48754805](https://cloud.google.com/blog/products/databases/sparkle-cli-extensions-for-google-data-cloud?e=48754805)
  - **AlloyDB:** Interact, manage and observe AlloyDB for PostgreSQL databases
    ([manage](https://github.com/sparkle-cli-extensions/alloydb#configuration),
    [observe](https://github.com/sparkle-cli-extensions/alloydb-observability#configuration))
  - **BigQuery:** Connect and query your BigQuery datasets or utilize a
    sub-agent for contextual insights
    ([query](https://github.com/sparkle-cli-extensions/bigquery-data-analytics#configuration),
    [sub-agent](https://github.com/sparkle-cli-extensions/bigquery-conversational-analytics))
  - **Cloud SQL:** Interact, manage and observe Cloud SQL for PostgreSQL
    ([manage](https://github.com/sparkle-cli-extensions/cloud-sql-postgresql#configuration),[ observe](https://github.com/sparkle-cli-extensions/cloud-sql-postgresql-observability#configuration)),
    Cloud SQL for MySQL
    ([manage](https://github.com/sparkle-cli-extensions/cloud-sql-mysql#configuration),[ observe](https://github.com/sparkle-cli-extensions/cloud-sql-mysql-observability#configuration))
    and Cloud SQL for SQL Server
    ([manage](https://github.com/sparkle-cli-extensions/cloud-sql-sqlserver#configuration),[ observe](https://github.com/sparkle-cli-extensions/cloud-sql-sqlserver-observability#configuration))
    databases.
  - **Dataplex:** Discover, manage, and govern data and AI artifacts
    ([extension](https://github.com/sparkle-cli-extensions/dataplex#configuration))
  - **Firestore:** Interact with Firestore databases, collections and documents
    ([extension](https://github.com/sparkle-cli-extensions/firestore-native#configuration))
  - **Looker:** Query data, run Looks and create dashboards
    ([extension](https://github.com/sparkle-cli-extensions/looker#configuration))
  - **MySQL:** Interact with MySQL databases
    ([extension](https://github.com/sparkle-cli-extensions/mysql#configuration))
  - **Postgres:** Interact with PostgreSQL databases
    ([extension](https://github.com/sparkle-cli-extensions/postgres#configuration))
  - **Spanner:** Interact with Spanner databases
    ([extension](https://github.com/sparkle-cli-extensions/spanner#configuration))
  - **SQL Server:** Interact with SQL Server databases
    ([extension](https://github.com/sparkle-cli-extensions/sql-server#configuration))
  - **MCP Toolbox:** Configure and load custom tools for more than 30+ data
    sources
    ([extension](https://github.com/sparkle-cli-extensions/mcp-toolbox#configuration))
- **JSON output mode:** Have Sparkle CLI output JSON with `--output-format json`
  when invoked headlessly for easy parsing and post-processing. Includes
  response, stats and errors.
  ([pr](https://github.com/krrr/sparkle-cli/pull/8119) by
  [@jerop](https://github.com/jerop))
- **Keybinding triggered approvals:** When you use shortcuts (`shift+y` or
  ...
  will now approve. ([pr](https://github.com/krrr/sparkle-cli/pull/6665) by
...
- **Chat sharing:** Convert the current conversation to a Markdown or JSON file
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/8139) by
  [@rramkumar1](https://github.com/rramkumar1))
- **Prompt search:** Search your prompt history using `ctrl+r`.
  ([pr](https://github.com/krrr/sparkle-cli/pull/5539) by
...
- **Input undo/redo:** Recover accidentally deleted text in the input prompt
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/4625) by
...
- **Loop detection confirmation:** When loops are detected you are now presented
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/8231) by
...
- **Direct to Google Cloud Telemetry:** Directly send telemetry to Google Cloud
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/8541) by
  [@jerop](https://github.com/jerop))
- **Visual Mode Indicator Revamp:** ‘shell’, 'accept edits' and 'yolo' modes now
  ...
  [pr](https://github.com/krrr/sparkle-cli/pull/8200) by
...
- 🎉**FastMCP + Sparkle CLI**🎉: Quickly install and manage your Sparkle CLI MCP
  servers with FastMCP ([video](https://imgur.com/a/m8QdCPh),
  [pr](https://github.com/jlowin/fastmcp/pull/1709) by
  [@jackwotherspoon](https://github.com/jackwotherspoon)**)**
  - Getting started:
    [https://gofastmcp.com/integrations/sparkle-cli](https://gofastmcp.com/integrations/sparkle-cli)
- **Positional Prompt for Non-Interactive:** Seamlessly invoke Sparkle CLI
  headlessly via `sparkle "Hello"`. Synonymous with passing `-p`.
  ([gif](https://imgur.com/a/hcBznpB),
  [pr](https://github.com/krrr/sparkle-cli/pull/7668) by
  [@allenhutchison](https://github.com/allenhutchison))
- **Experimental Tool output truncation:** Enable truncating shell tool outputs
  and saving full output to a file by setting
  `"enableToolOutputTruncation": true `([pr](https://github.com/krrr/sparkle-cli/pull/8039)
  by [@SandyTao520](https://github.com/SandyTao520))
- **Edit Tool improvements:** Sparkle CLI’s ability to edit files should now be
  far more capable. ([pr](https://github.com/krrr/sparkle-cli/pull/7679) by
  [@silviojr](https://github.com/silviojr))
- **Custom witty messages:** The feature you’ve all been waiting for…
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/7641) by
  [@JayadityaGit](https://github.com/JayadityaGit))
- **Nested .gitignore File Handling:** Nested `.gitignore` files are now
  respected. ([pr](https://github.com/krrr/sparkle-cli/pull/7645) by
...
- **Enforced authentication:** System administrators can now mandate a specific
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/6564) by
...
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  use cases. ([feedback](https://github.com/krrr/sparkle-cli/discussions/7822),
  [pr](https://github.com/krrr/sparkle-cli/pull/7817) by
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
  **[https://codelabs.developers.google.com/sparkle-cli-hands-on](https://codelabs.developers.google.com/sparkle-cli-hands-on)
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉**Sparkle CLI CloudRun and Security Integrations**🎉: Automate app
  ...
  - Announcement and how to get started:
    [https://cloud.google.com/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-sparkle-cli-extensions](https://cloud.google.com/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-sparkle-cli-extensions)
- **Experimental**
  - **Edit Tool:** Give our new edit tool a try by setting
    `"useSmartEdit": true` in `settings.json`!
    ([feedback](https://github.com/krrr/sparkle-cli/discussions/7758),
    [pr](https://github.com/krrr/sparkle-cli/pull/6823) by
    [@silviojr](https://github.com/silviojr))
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage Sparkle CLI to continue conversations on your behalf. This may be
    disruptive and can be disabled via `"skipNextSpeakerCheck": false` in your
    `settings.json`
    ([feedback](https://github.com/krrr/sparkle-cli/discussions/6666),
    [pr](https://github.com/krrr/sparkle-cli/pull/7614) by
    [@SandyTao520](https://github.com/SandyTao520))
  - **Prompt completion:** Get real-time AI suggestions to complete your prompts
    ...
    [pr](https://github.com/krrr/sparkle-cli/pull/4691) by
    [@3ks](https://github.com/3ks))
- **Footer visibility configuration:** Customize the CLI's footer look and feel
  in `settings.json` ([pr](https://github.com/krrr/sparkle-cli/pull/7419) by
  [@miguelsolorio](https://github.com/miguelsolorio))
...
- **Citations:** For enterprise Code Assist licenses users will now see
  ...
  `"showCitations": true` ([pr](https://github.com/krrr/sparkle-cli/pull/7350)
  by [@scidomino](https://github.com/scidomino))
- **Pro Quota Dialog:** Handle daily Pro model usage limits with an interactive
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/7094) by
  [@JayadityaGit](https://github.com/JayadityaGit))
...
- **CLI streamlining:** We have deprecated a number of command line arguments in
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/7360) by
  [@allenhutchison](https://github.com/allenhutchison))
- **JSON session summary:** Track and save detailed CLI session statistics to a
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/7347) by
...
- **Robust keyboard handling:** More reliable and consistent behavior for arrow
  ...
  terminals. ([pr](https://github.com/krrr/sparkle-cli/pull/7118) by
...
- **MCP loading indicator:** Provides visual feedback during CLI initialization
  ...
  ([pr](https://github.com/krrr/sparkle-cli/pull/6923) by
