...
```bash
export SPARKLE_CLI_SURFACE="my-custom-tool"
```
...
These logs track how Sparkle CLI selects and routes requests to models.
...
Sparkle CLI exports several custom metrics.
...
Sparkle CLI provides detailed performance metrics for advanced monitoring.
