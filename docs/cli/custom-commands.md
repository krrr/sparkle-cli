...
prompts as personal shortcuts within Sparkle CLI. You can create commands that
...
When a custom command attempts to execute a shell command, Sparkle CLI will now
