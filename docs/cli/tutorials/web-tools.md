...
Sparkle uses the `web_search` tool to find relevant pages and synthesizes an
answer. This "grounding" process ensures the agent isn't hallucinating features
that don't exist.
...
Sparkle will retrieve the page content (stripping away ads and navigation) and
