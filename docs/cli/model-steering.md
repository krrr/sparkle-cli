...
Model steering lets you provide real-time guidance and feedback to Sparkle CLI
...
When model steering is enabled, Sparkle CLI treats any text you type while the
...
Sparkle CLI acknowledges your hint with a brief message and injects it directly
