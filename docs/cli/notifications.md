...
Sparkle CLI can send system notifications to alert you when a session completes
...
[Plan Mode](./plan-mode.md), letting you switch to other windows while Sparkle
...
notifications, Sparkle CLI falls back to a terminal bell (BEL) to get your
