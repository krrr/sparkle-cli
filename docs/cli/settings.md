...
| OpenAI Base URL                       | `security.auth.openaiBaseUrl`                   | The base URL of the OpenAI-compatible API (e.g. https://api.openai.com/v1). Falls back to the OPENAI_BASE_URL environment variable, then to the default OpenAI endpoint. | `undefined` |
