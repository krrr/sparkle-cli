...
| Tool                                             | Kind    | Description                                                                           |
| :----------------------------------------------- | :------ | :------------------------------------------------------------------------------------ |
| [`activate_skill`](../tools/activate-skill.md)   | `Other` | Loads specialized procedural expertise from the `.sparkle/skills` directory.          |
| [`get_internal_docs`](../tools/internal-docs.md) | `Think` | Accesses Sparkle CLI's own documentation for accurate answers about its capabilities. |
...
| `glob`                   | `pattern`, `dir_path`, `case_sensitive`, `respect_git_ignore`, `respect_sparkle_ignore`                                                                                                              |
