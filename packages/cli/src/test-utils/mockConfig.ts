...
import { NoopSandboxManager } from 'sparkle-cli-core';
...
export const createMockConfig = (overrides: Partial<Config> = {}): Config =>
  ({
    ...
    getProviderProfileService: vi.fn().mockReturnValue({
      ...
      createProfile: vi.fn().mockResolvedValue({ id: 'mock-profile-1' }),
    ...
    getFileFilteringRespectSparkleIgnore: vi.fn().mockReturnValue(true),
