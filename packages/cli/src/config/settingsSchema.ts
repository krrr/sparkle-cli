      ...
      plan: {
        ...
        properties: {
          ...
          directory: {
            ...
            default: undefined as string | undefined,
            description:
              'The directory where planning artifacts are stored. If not specified, defaults to the managed data directory. A custom directory requires a policy to allow write access in Plan Mode.',
            showInDialog: true,
          },
          modelRouting: {
            type: 'boolean',
  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Sparkle CLI model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
