...
import { isNodeError, Storage } from 'sparkle-cli-core';
...
export const commandDescriptions: Readonly<Record<Command, string>> = {
  ...
  [Command.FOCUS_SHELL_INPUT]: 'Move focus from Sparkle to the active shell.',
  [Command.UNFOCUS_SHELL_INPUT]: 'Move focus from the shell back to Sparkle.',
