...
// File for 'sparkle mcp add' command
import type { CommandModule } from 'yargs';
import { loadSettings, SettingScope } from '../../config/settings.js';
import { debugLogger, type MCPServerConfig } from 'sparkle-cli-core';
...
export const addCommand: CommandModule = {
  ...
  builder: (yargs) =>
    yargs
      .usage('Usage: sparkle mcp add [options] <name> <commandOrUrl> [args...]')
      .parserConfiguration({
