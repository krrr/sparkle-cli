...
To standardize client integrations with the Sparkle CLI agent, this document
...
required for rich, interactive workflows with the Sparkle CLI agent.

### 1.2 Motivation

Recent work integrating Sparkle CLI with clients like Zed and Gemini Code
...
workflows between a client and the Sparkle CLI agent. It consists of a
...
This method allows the client to discover slash commands supported by Sparkle
