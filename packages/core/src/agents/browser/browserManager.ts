...
// Default browser profile directory name within ~/.sparkle/
...
export class BrowserManager {
  ...
  private async connectMcp(): Promise<void> {
    ...
    // - "persistent": Persistent profile at ~/.sparkle/cli-browser-profile/ (default)
    ...
    if (browserConfig.customConfig.profilePath) {
      ...
      // Default persistent profile lives under ~/.sparkle/cli-browser-profile
