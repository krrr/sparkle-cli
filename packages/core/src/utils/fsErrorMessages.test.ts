    ...
    const testCases: FsErrorCase[] = [
      {
        ...
        path: '/etc/sparkle-cli/settings.json',
        expected:
          "Permission denied: cannot access '/etc/sparkle-cli/settings.json'. Check file permissions or run with elevated privileges.",
      },
      {
        code: 'EACCES',
        message: 'EACCES: permission denied',
