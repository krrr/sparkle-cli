...
/**
 * Decoupled LLM request format - stable across Sparkle CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across Sparkle CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across Sparkle CLI versions
 */
