...
describe('getIdeProcessInfo', () => {
  ...
  describe('SPARKLE_CLI_IDE_PID override', () => {
    it('should use SPARKLE_CLI_IDE_PID and fetch command on Unix', async () => {
      (os.platform as Mock).mockReturnValue('linux');
      vi.stubEnv('SPARKLE_CLI_IDE_PID', '12345');
    ...
    it('should use SPARKLE_CLI_IDE_PID and fetch command on Windows', async () => {
      (os.platform as Mock).mockReturnValue('win32');
      vi.stubEnv('SPARKLE_CLI_IDE_PID', '54321');
      const processes = [
        {
          ProcessId: 54321,
          ParentProcessId: 0,
