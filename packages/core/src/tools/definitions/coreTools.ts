...
/**
 * Core tool declarations exposed to the model, plus re-exported name constants.
 */
...
// Re-exported tool and parameter name constants.
export {
  GLOB_TOOL_NAME,
  GREP_TOOL_NAME,
  LS_TOOL_NAME,
...
export const WRITE_FILE_DECLARATION: FunctionDeclaration = {
...
export const GREP_DECLARATION: FunctionDeclaration = {
  name: GREP_TOOL_NAME,
  description:
...
export const RIP_GREP_DECLARATION: FunctionDeclaration = {
  name: GREP_TOOL_NAME,
  description:
...
export const GLOB_DECLARATION: FunctionDeclaration = {
  name: GLOB_TOOL_NAME,
  description:
...
export const LS_DECLARATION: FunctionDeclaration = {
  name: LS_TOOL_NAME,
  description:
...
export const EDIT_DECLARATION: FunctionDeclaration = {
  name: EDIT_TOOL_NAME,
...
export const WEB_FETCH_DECLARATION: FunctionDeclaration = {
...
export const READ_MANY_FILES_DECLARATION: FunctionDeclaration = {
...
export const WRITE_TODOS_DECLARATION: FunctionDeclaration = {
...
export const GET_INTERNAL_DOCS_DECLARATION: FunctionDeclaration = {
  name: GET_INTERNAL_DOCS_TOOL_NAME,
  description:
    'Returns the content of Sparkle CLI internal documentation files. If no path is provided, returns a list of all available documentation paths.',
  parametersJsonSchema: {
    type: 'object',
    properties: {
      [DOCS_PARAM_PATH]: {
...
export const ASK_USER_DECLARATION: FunctionDeclaration = {
...
export const ENTER_PLAN_MODE_DECLARATION: FunctionDeclaration = {
...
export const READ_MCP_RESOURCE_DECLARATION: FunctionDeclaration = {
