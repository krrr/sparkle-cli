...
export const TRACKER_CREATE_TASK_DECLARATION: FunctionDeclaration = {
...
export const TRACKER_UPDATE_TASK_DECLARATION: FunctionDeclaration = {
...
export const TRACKER_GET_TASK_DECLARATION: FunctionDeclaration = {
...
export const TRACKER_LIST_TASKS_DECLARATION: FunctionDeclaration = {
...
export const TRACKER_ADD_DEPENDENCY_DECLARATION: FunctionDeclaration = {
...
export const TRACKER_VISUALIZE_DECLARATION: FunctionDeclaration = {
