...
## sticky footer transition boundary

> scrollTop: 5 - Footer 1 line below bottom (should be stuck)
...
> scrollTop: 6 - Footer exactly at bottom (should be natural)
...
> scrollTop: 7 - Footer 1 line above bottom (should be natural)
